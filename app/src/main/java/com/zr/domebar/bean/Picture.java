...
public class Picture implements Parcelable {
    ...
    public static class ShowapiResBodyBean implements Parcelable {
        ...
        public static class PagebeanBean implements Parcelable {
            ...
            public List<Pic> getContentlist() {
                return contentlist;
            }

            public void setContentlist(List<Pic> contentlist) {
            ...
            protected PagebeanBean(Parcel in) {
                ...
                this.contentlist = new ArrayList<Pic>();
                in.readList(this.contentlist, Pic.class.getClassLoader());
            }
